...
def decide(features: Dict) -> Dict:
    ...
    prompt = {
        "policy": "Capital saved is capital earned. Avoid hard targets; "
        "use structure, flow and risk.",
        "features": features,
    ...
    resp = client.chat.completions.create(
        ...
        messages=[
            {
                "role": "system",
                "content": "You are an unemotional intraday risk manager. Decide action. "
                "Be concise.",
            },
    ...
    try:
        ...
        data = {"action": "HOLD", "why": "Model output malformed; default HOLD", "confidence": 0.3}
    return data
